  ...
  function tweetDraw() {
    ...
    if (tweetArray.length > 0) {
      ...
      tweetArray.forEach(function() {
        ...
        tweetHtml +=
        '<div class="stream-item"><div class="stream-item-header"><img src="assets/img/profile.jpg" width="48" height="48"><span class="full-name">Yoshiki Kojima</span><span class="user-name">@yoshikikoji</span></div><div class="tweet-text">' +
        tweetArray[i] +
        "</div></div>";
      i--;
    });
